...
import fr.labri.popsycle.algo.deps.BriandFinder;
...
public class TestBriandFinder {

	@Test
	public void testBriandFinder() {
		JPackageGroup pkgGrp = getTestJPackageGroup();
		
		BriandFinder f1 = new BriandFinder(pkgGrp);
		Set<JPackageDep> deps = f1.extractJPackageDeps();

		System.out.println("Should be: [UI -> PackA (ITF 4)]");
