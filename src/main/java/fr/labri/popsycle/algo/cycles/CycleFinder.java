...
public abstract class CycleFinder extends Finder {
	
	protected Set<JPackageCycle> cycles;

	public CycleFinder(JPackageGroup pkgGrp) {
		super(pkgGrp);
	}
	
	public abstract Set<JPackageCycle> extractJPackageCycles();
