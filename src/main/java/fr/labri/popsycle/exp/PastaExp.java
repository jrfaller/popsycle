...
public class PastaExp {
	
	public static void main(String[] args) throws Exception {
		CDGReader imp = new CDGReader("cdg/pharo.cdg");
		
		JClassGroup clsGrp = imp.read()	;
		JPackageGroup pkgGrp = clsGrp.extractJPackageGroup();

		JPackageDepsFinder f = new PastaFinder(pkgGrp);
		Set<JPackageDep> pasta = f.extractJPackageDeps();
		for(JPackageDep dep: pasta) 
